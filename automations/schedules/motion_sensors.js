...
cronSchedule('0 5 * * *', generalRooms, 'switch', 'turn_on', 'Turn on general rooms motion sensors at 0500');

cronSchedule('0 9 * * *', bedrooms, 'switch', 'turn_on', 'Turn on bedroom motion sensors at 0900');

cronSchedule('0 21 * * *', bedrooms, 'switch', 'turn_off', 'Turn off bedroom motion sensors at 2100');
